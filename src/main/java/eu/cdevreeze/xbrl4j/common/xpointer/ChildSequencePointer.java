...
/**
 * Element scheme child sequence pointer. The child element sequence is 1-based, not 0-based.
 *
 * @author Chris de Vreeze
 */
public record ChildSequencePointer(ImmutableList<Integer> childElementSequence) implements ElementSchemePointer {

    public ChildSequencePointer {
