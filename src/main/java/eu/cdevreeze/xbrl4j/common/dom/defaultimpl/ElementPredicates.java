...
public class ElementPredicates {
    ...
    public static Predicate<ElementTree.Element> hasAttributeWithName(QName attrName) {
        return factory.hasAttributeWithName(attrName);
    }

    public static Predicate<ElementTree.Element> hasAttributeWithName(String attrNamespace, String attrLocalName) {
        return factory.hasAttributeWithName(attrNamespace, attrLocalName);
    }

    public static Predicate<ElementTree.Element> hasAttributeWithName(String attrNoNamespaceName) {
        return factory.hasAttributeWithName(attrNoNamespaceName);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(QName attrName, Predicate<String> attrValuePredicate) {
        return factory.hasAttributeValue(attrName, attrValuePredicate);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(String attrNamespace, String attrLocalName, Predicate<String> attrValuePredicate) {
        return factory.hasAttributeValue(attrNamespace, attrLocalName, attrValuePredicate);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(String attrNoNamespaceName, Predicate<String> attrValuePredicate) {
        return factory.hasAttributeValue(attrNoNamespaceName, attrValuePredicate);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(QName attrName, String attrValue) {
        return factory.hasAttributeValue(attrName, attrValue);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(String attrNamespace, String attrLocalName, String attrValue) {
        return factory.hasAttributeValue(attrNamespace, attrLocalName, attrValue);
    }

    public static Predicate<ElementTree.Element> hasAttributeValue(String attrNoNamespaceName, String attrValue) {
     ...
     */
    public static final class Factory implements ElementPredicateFactoryApi<ElementTree.Element> {
        ...
        @Override
        public Predicate<ElementTree.Element> hasName(QName name) {
            return e -> underlyingFactory.hasName(name).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasName(String namespace, String localName) {
            return e -> underlyingFactory.hasName(namespace, localName).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasName(String noNamespaceName) {
            return e -> underlyingFactory.hasName(noNamespaceName).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeWithName(QName attrName) {
            return e -> underlyingFactory.hasAttributeWithName(attrName).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeWithName(String attrNamespace, String attrLocalName) {
            return e -> underlyingFactory.hasAttributeWithName(attrNamespace, attrLocalName).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeWithName(String attrNoNamespaceName) {
            return e -> underlyingFactory.hasAttributeWithName(attrNoNamespaceName).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(QName attrName, Predicate<String> attrValuePredicate) {
            return e -> underlyingFactory.hasAttributeValue(attrName, attrValuePredicate).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(String attrNamespace, String attrLocalName, Predicate<String> attrValuePredicate) {
            return e -> underlyingFactory.hasAttributeValue(attrNamespace, attrLocalName, attrValuePredicate).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(String attrNoNamespaceName, Predicate<String> attrValuePredicate) {
            return e -> underlyingFactory.hasAttributeValue(attrNoNamespaceName, attrValuePredicate).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(QName attrName, String attrValue) {
            return e -> underlyingFactory.hasAttributeValue(attrName, attrValue).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(String attrNamespace, String attrLocalName, String attrValue) {
            return e -> underlyingFactory.hasAttributeValue(attrNamespace, attrLocalName, attrValue).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasAttributeValue(String attrNoNamespaceName, String attrValue) {
            return e -> underlyingFactory.hasAttributeValue(attrNoNamespaceName, attrValue).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasOnlyText(Predicate<String> textPredicate) {
            return e -> underlyingFactory.hasOnlyText(textPredicate).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasOnlyText(String text) {
            return e -> underlyingFactory.hasOnlyText(text).test(e.underlyingElement());
        }

        @Override
        public Predicate<ElementTree.Element> hasOnlyStrippedText(String text) {
