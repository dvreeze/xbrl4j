...
import eu.cdevreeze.xbrl4j.model.link.PresentationLink;
 ...
 */
public class PresentationLinkImpl extends XmlElementImpl implements PresentationLink {

    public PresentationLinkImpl(
    ...
    @Override
    public ImmutableList<? extends PresentationArc> arcs() {
        return childElementStream(PresentationArc.class).collect(ImmutableList.toImmutableList());
    }
