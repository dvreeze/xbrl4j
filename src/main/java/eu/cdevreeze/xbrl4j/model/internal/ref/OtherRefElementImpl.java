...
import eu.cdevreeze.xbrl4j.model.ref.OtherRefElement;

import java.util.function.Function;

/**
 * Implementation of OtherRefElement.
 *
 * @author Chris de Vreeze
 */
public class OtherRefElementImpl extends XmlElementImpl implements OtherRefElement {

    public OtherRefElementImpl(
