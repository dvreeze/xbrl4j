...
import eu.cdevreeze.xbrl4j.model.label.OtherLabelElement;
import eu.cdevreeze.yaidom4j.queryapi.AncestryAwareElementApi;

import java.util.function.Function;

/**
 * Implementation of OtherLabelElement.
 *
 * @author Chris de Vreeze
 */
public class OtherLabelElementImpl extends XmlElementImpl implements OtherLabelElement {

    public OtherLabelElementImpl(
