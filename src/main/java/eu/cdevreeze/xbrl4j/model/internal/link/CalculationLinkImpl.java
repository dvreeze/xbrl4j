...
import eu.cdevreeze.xbrl4j.model.link.CalculationLink;
...
/**
 * Implementation of CalculationLink.
 *
 * @author Chris de Vreeze
 */
public class CalculationLinkImpl extends XmlElementImpl implements CalculationLink {

    public CalculationLinkImpl(
    ...
    @Override
    public ImmutableList<? extends CalculationArc> arcs() {
        return childElementStream(CalculationArc.class).collect(ImmutableList.toImmutableList());
    }
