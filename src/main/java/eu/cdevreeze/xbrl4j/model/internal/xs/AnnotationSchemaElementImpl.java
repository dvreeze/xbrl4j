...
import eu.cdevreeze.xbrl4j.model.xs.AnnotationSchemaElement;
import eu.cdevreeze.yaidom4j.queryapi.AncestryAwareElementApi;

import java.util.function.BiFunction;

/**
 * Implementation of AnnotationSchemaElement.
 *
 * @author Chris de Vreeze
 */
public class AnnotationSchemaElementImpl extends XmlElementImpl implements AnnotationSchemaElement {

    public AnnotationSchemaElementImpl(
