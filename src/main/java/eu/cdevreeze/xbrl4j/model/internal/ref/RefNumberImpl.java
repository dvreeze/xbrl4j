...
import eu.cdevreeze.xbrl4j.model.ref.RefNumber;

import java.util.function.Function;

/**
 * Implementation of RefNumber.
 *
 * @author Chris de Vreeze
 */
public class RefNumberImpl extends XmlElementImpl implements RefNumber {

    public RefNumberImpl(
