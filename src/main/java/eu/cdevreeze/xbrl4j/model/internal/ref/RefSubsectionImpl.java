...
import eu.cdevreeze.xbrl4j.model.ref.RefSubsection;

import java.util.function.Function;

/**
 * Implementation of RefSubsection.
 *
 * @author Chris de Vreeze
 */
public class RefSubsectionImpl extends XmlElementImpl implements RefSubsection {

    public RefSubsectionImpl(
