...
import eu.cdevreeze.xbrl4j.model.ref.RefChapter;

import java.util.function.Function;

/**
 * Implementation of RefChapter.
 *
 * @author Chris de Vreeze
 */
public class RefChapterImpl extends XmlElementImpl implements RefChapter {

    public RefChapterImpl(
