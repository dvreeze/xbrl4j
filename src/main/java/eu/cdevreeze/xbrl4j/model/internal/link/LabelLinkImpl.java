...
import eu.cdevreeze.xbrl4j.model.link.LabelArc;
import eu.cdevreeze.xbrl4j.model.link.LabelLink;
...
/**
 * Implementation of LabelLink.
 *
 * @author Chris de Vreeze
 */
public class LabelLinkImpl extends XmlElementImpl implements LabelLink {

    public LabelLinkImpl(
    ...
    @Override
    public ImmutableList<? extends LabelArc> arcs() {
