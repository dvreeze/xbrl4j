...
import eu.cdevreeze.xbrl4j.model.ref.RefIssueDate;

import java.util.function.Function;

/**
 * Implementation of RefIssueDate.
 *
 * @author Chris de Vreeze
 */
public class RefIssueDateImpl extends XmlElementImpl implements RefIssueDate {

    public RefIssueDateImpl(
