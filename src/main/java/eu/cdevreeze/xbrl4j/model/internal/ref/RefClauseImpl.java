...
import eu.cdevreeze.xbrl4j.model.ref.RefClause;

import java.util.function.Function;

/**
 * Implementation of RefClause.
 *
 * @author Chris de Vreeze
 */
public class RefClauseImpl extends XmlElementImpl implements RefClause {

    public RefClauseImpl(
