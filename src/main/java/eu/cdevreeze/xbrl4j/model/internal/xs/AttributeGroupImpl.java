...
import eu.cdevreeze.xbrl4j.model.xs.AttributeGroup;
import eu.cdevreeze.yaidom4j.queryapi.AncestryAwareElementApi;

import java.util.function.BiFunction;

/**
 * Implementation of AttributeGroup.
 *
 * @author Chris de Vreeze
 */
public class AttributeGroupImpl extends XmlElementImpl implements AttributeGroup {
