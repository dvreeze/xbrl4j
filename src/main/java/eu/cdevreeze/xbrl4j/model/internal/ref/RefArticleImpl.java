...
import eu.cdevreeze.xbrl4j.model.ref.RefArticle;

import java.util.function.Function;

/**
 * Implementation of RefArticle.
 *
 * @author Chris de Vreeze
 */
public class RefArticleImpl extends XmlElementImpl implements RefArticle {

    public RefArticleImpl(
